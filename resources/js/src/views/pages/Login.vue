              ...
              <div class="p-8 login-tabs-container">
                ...
                <div>
                  <vs-input
                      ...
                      v-model="form.email"
                      class="w-full"/>
                    <small v-if="form.errors.has('email')" class="text-danger">{{ form.errors.get('email') }}</small>
                    <br>
                    <vs-input
                      type="password"
                      name="password"
                      ...
                      class="w-full mt-6" />
                    <small v-if="form.errors.has('password')" class="text-danger">{{ form.errors.get('password') }}</small>
                    <br>
                  <div class="flex flex-wrap justify-between my-5">
                      <router-link to="">Forgot Password?</router-link>
                  </div>

                  <vs-button class="float-right" @click="submitForm" :disabled="form.errors.any() || loginBtn === 'Authenticating ...'">{{ loginBtn }}</vs-button>

                    <small v-if="form.errors.has('message')" class="text-danger">{{ form.errors.get('message') }}</small>
...
import LoginForm from '../../core/utilities/LoginForm'
